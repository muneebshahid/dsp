...
namespace dynamic_shortest_path
{
	...
	{
		public:
			Dsp(int num_connections, float hidden_threshold, int mult_hyp_dist, unsigned int width)
			...
			void print();
		private:
			void update_graph(std::vector<float> new_nodes, std::vector<float> new_edges);
